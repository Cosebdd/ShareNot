...
namespace ShareNot.Controls
{
    partial class TaskThumbnailPanel
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.lblTitle = new BlackStyleLabel();
            this.pThumbnail = new TaskRoundedCornerPanel();
            this.lblCombineVertical = new BlackStyleLabel();
            this.lblError = new BlackStyleLabel();
            this.lblCombineHorizontal = new BlackStyleLabel();
            ...
            this.pThumbnail.StatusLocation = ThumbnailTitleLocation.Top;
